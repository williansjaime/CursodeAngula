...
const EXAMPLE_DATA: Product[] = [ //ProductRead2Item[] = [
 ...
 */
export class ProductRead2DataSource extends DataSource<Product>{//ProductRead2Item> {
  data: Product[] = EXAMPLE_DATA; //ProductRead2Item[] = EXAMPLE_DATA;
   ...
   */
  connect(): Observable<Product[]>{//ProductRead2Item[]> {
   ...
   */
  private getPagedData(data: Product[]):Product[]{//ProductRead2Item[]): ProductRead2Item[] {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: Product[]):Product[] {//ProductRead2Item[]): ProductRead2Item[] {
